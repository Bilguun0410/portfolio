(function () {
  ...
  var PROJECTS = [
    { name: 'msmgroup.mn',  role: 'LEAD FRONTEND',  meta: 'NEXT.JS · 2024'   },
    { name: 'erxes.io',     role: 'FRONTEND',        meta: 'REACT · 2023'     },
    { name: 'erxes XOS',    role: 'FRONTEND LEAD',   meta: 'REACT · ONGOING'  },
  ];
  ...
  workRows.forEach(function (row) {
    ...
    row.addEventListener('mouseenter', function () { showPreview(idx); });
